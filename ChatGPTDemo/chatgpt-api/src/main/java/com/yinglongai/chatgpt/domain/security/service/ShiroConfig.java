...
import com.yinglongai.chatgpt.domain.security.service.realm.JwtRealm;
...
public class ShiroConfig {
    ...
    public DefaultWebSecurityManager securityManager() {
        ...
        // 不需要将 Shiro Session 中的东西存到任何地方（包括Http Session中）
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean() {
        ...
        // 拦截器
        // 指定方法走哪个拦截器[login->anon][logout->logout][verify->jwt]
