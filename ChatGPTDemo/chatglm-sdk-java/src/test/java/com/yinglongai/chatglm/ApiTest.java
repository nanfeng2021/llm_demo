...
import com.yinglongai.chatglm.session.deafult.DefaultOpenAiSessionFactory;
...
public class ApiTest {
    ...
    public void test_OpenAiSessionFactory() {
        ...
        configuration.setApiSecretKey("c25296db0cc7bc99e8c120d739550c41.0MZLPI39g7vDiaTZ");
    ...
    public void test_completions_new() throws Exception{
        ...
        // 2024年1月发布的glm-3-turbo、glm-4 支持函数、知识库、联网功能
        request.setTools(new ArrayList<ChatCompletionRequest.Tool>() {
            private static final long serialVersionUID = 7988151926241837899L;
        ...
        request.setMessages(new ArrayList<ChatCompletionRequest.Prompt>() {
...

            {
                ...
                add(
                        ...
                        .role(Role.user.getCode())
                        .content(
                                ChatCompletionRequest.Prompt.Content.builder()
                ...
                add(
                     ...
                     .content(
                             ...
                             .imageUrl(ChatCompletionRequest.Prompt.Content.ImageUrl.builder()
                                     .url("https" +
                                     "://bugstack.cn/images/article/project/chatgpt/chatgpt-extra-231011-01.png")
                                     .build())
                             .build()
                     )
                     .build()
     ...
     */
    @Test
    public void test_completion_sync() throws Exception {
        // 入参：模型、请求信息
        ChatCompletionRequest request = new ChatCompletionRequest();
        request.setModel(Model.GLM_3_5_TURBO);
        request.setPrompt(new ArrayList<ChatCompletionRequest.Prompt>(){
